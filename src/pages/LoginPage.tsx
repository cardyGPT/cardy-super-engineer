...
import { Github, Mail, Eye, EyeOff, ChevronRight, ArrowLeft } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const { login, loginWithGoogle, loginWithGitHub, signUp, forgotPassword, isAuthenticated } = useAuth();
