...
export function Step({
  ...
  const getStatusClasses = () => {
    if (completed) {
      return "bg-green-50 text-green-700 border-green-500 shadow-[0_0_0_4px_rgba(16,185,129,0.1)]";
    } else if (processing) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center gap-2 text-center cursor-pointer transition-all duration-300 hover:opacity-90",
        className
      )}
      {...props}
    >
